...
public class JdbcRoomMatchDao implements RoomMatchDao {
	...
	private final String SQL_DELROOM_MTACH = "DELETE FROM room_match WHERE user_id = ? AND room_id = ?";
	...
	public List<String> deleteRoomMatch(CanceledRoom canceledRoom) {
		jdbcTemplate.update(SQL_DELROOM_MTACH, canceledRoom.getUser_id(), canceledRoom.getRoom_id());
